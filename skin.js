...
// Filename: skin for testing.ggsk
// Generated 2025-07-23T17:59:41
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		el.ggType='text';
		hs ='';
		hs+='background : rgba(229,184,121,0.588235);';
		hs+='border-color : #a18155;';
		hs+='border-radius : 5px 5px 5px 5px;';
		...
		me._text_1.logicBlock_backgroundcolor = function() {
			...
			if (me._text_1.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				...
				me._text_1.style.transition='background-color 500ms ease 0ms';
				if (me._text_1.ggCurrentLogicStateBackgroundColor == 0) {
					me._text_1.style.backgroundColor="rgba(229,184,121,1)";
				}
				else {
					me._text_1.style.backgroundColor="rgba(229,184,121,0.588235)";
				}
			}
		}
		...
		el=me._text_1_en=document.createElement('div');
		els=me._text_1_en__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="Text 1_en";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		...
		hs+='text-overflow: ellipsis;';
		els.setAttribute('style',hs);
		me._text_1_en.ggUpdateText=function() {
			var params = [];
			var hs = player._("Introduction", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._text_1_en.ggUpdateText();
		el.appendChild(els);
		me._text_1_en.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._text_1_en.logicBlock_backgroundcolor = function() {
			var newLogicStateBackgroundColor;
			if (
				((me.elementMouseOver['text_1_en'] == true))
			)
			{
				newLogicStateBackgroundColor = 0;
			}
			...
			if (me._text_1_en.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				me._text_1_en.ggCurrentLogicStateBackgroundColor = newLogicStateBackgroundColor;
				me._text_1_en.style.transition='background-color 500ms ease 0ms';
				if (me._text_1_en.ggCurrentLogicStateBackgroundColor == 0) {
					me._text_1_en.style.backgroundColor="rgba(229,184,121,1)";
				}
				else {
					me._text_1_en.style.backgroundColor="rgba(229,184,121,0.588235)";
				}
			}
		}
		me._text_1_en.logicBlock_backgroundcolor();
		me._text_1_en.onmouseenter=function (e) {
			me.elementMouseOver['text_1_en']=true;
			me._text_1_en.logicBlock_backgroundcolor();
		}
		me._text_1_en.onmouseleave=function (e) {
			me.elementMouseOver['text_1_en']=false;
			me._text_1_en.logicBlock_backgroundcolor();
		}
		me._text_1_en.ggUpdatePosition=function (useTransition) {
		}
		me.divSkin.appendChild(me._text_1_en);
		el=me._translate=document.createElement('div');
		els=me._translate__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'AgMS00IDEwIDE1LjMgMTUuMyAwIDAgMS00LTEwIDE1LjMgMTUuMyAwIDAgMSA0LTEweiIvPgo8L3N2Zz4K';
		me._translate__img.setAttribute('src',hs);
		hs ='';
		...
		me._translate.onclick=function (e) {
			me._text_2.ggVisible = !me._text_2.ggVisible;
			var flag=me._text_2.ggVisible;
			me._text_2.style.transition='none';
			me._text_2.style.visibility=((flag)&&(Number(me._text_2.style.opacity)>0||!me._text_2.style.opacity))?'inherit':'hidden';
			me._text_2_1.ggVisible = !me._text_2_1.ggVisible;
			var flag=me._text_2_1.ggVisible;
			me._text_2_1.style.transition='none';
			me._text_2_1.style.visibility=((flag)&&(Number(me._text_2_1.style.opacity)>0||!me._text_2_1.style.opacity))?'inherit':'hidden';
		}
		...
		el.ggType='text';
		hs ='';
		hs+='background : rgba(214,187,150,0.588235);';
		hs+='border-color : #9f8a70;';
		hs+='border-style : solid;';
		hs+='border-width : 1px 1px 1px 1px;';
		hs+='color : #000000;';
		hs+='height : 16px;';
		...
		me._text_2_1.logicBlock_backgroundcolor = function() {
			var newLogicStateBackgroundColor;
			if (
				((me.elementMouseOver['text_2_1'] == true))
			)
			{
				newLogicStateBackgroundColor = 0;
			}
			...
			if (me._text_2_1.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				me._text_2_1.ggCurrentLogicStateBackgroundColor = newLogicStateBackgroundColor;
				me._text_2_1.style.transition='background-color 0s';
				if (me._text_2_1.ggCurrentLogicStateBackgroundColor == 0) {
					me._text_2_1.style.backgroundColor="rgba(214,187,150,0.882353)";
				}
				else {
					me._text_2_1.style.backgroundColor="rgba(214,187,150,0.588235)";
				}
			}
		}
		me._text_2_1.logicBlock_backgroundcolor();
		me._text_2_1.onclick=function (e) {
			...
			me._text_1_en.style.transition='none';
			me._text_1_en.style.visibility='hidden';
			me._text_1_en.ggVisible=false;
		}
		me._text_2_1.onmouseenter=function (e) {
			me.elementMouseOver['text_2_1']=true;
			me._text_2_1.logicBlock_backgroundcolor();
		}
		me._text_2_1.onmouseleave=function (e) {
			me.elementMouseOver['text_2_1']=false;
			me._text_2_1.logicBlock_backgroundcolor();
		}
		me._text_2_1.ggUpdatePosition=function (useTransition) {
		}
		me._translate.appendChild(me._text_2_1);
		...
		me._text_2.logicBlock_backgroundcolor = function() {
			...
			if (me._text_2.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				...
				if (me._text_2.ggCurrentLogicStateBackgroundColor == 0) {
					me._text_2.style.backgroundColor="rgba(214,187,150,0.882353)";
				}
				else {
					me._text_2.style.backgroundColor="rgba(214,187,150,0.588235)";
				}
			}
		}
		...
		me._text_2.onclick=function (e) {
			me._text_1_en.style.transition='none';
			me._text_1_en.style.visibility=(Number(me._text_1_en.style.opacity)>0||!me._text_1_en.style.opacity)?'inherit':'hidden';
			me._text_1_en.ggVisible=true;
			me._text_1.style.transition='none';
		...
		me._translate.appendChild(me._text_2);
		me.divSkin.appendChild(me._translate);
		...
		me._image_1.logicBlock_position = function() {
			...
			if (
				((player.getViewerSize(true).width > 1000))
			)
			{
			...
			if (me._image_1.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._image_1.style.transition='left 1000ms ease 0ms, top 1000ms ease 0ms, transform 1000ms ease 0ms';
				if (me._image_1.ggCurrentLogicStatePosition == 0) {
					me._image_1.style.left='70px';
					me._image_1.style.top='152px';
				}
				else if (me._image_1.ggCurrentLogicStatePosition == 1) {
					me._image_1.style.left='95px';
					me._image_1.style.top='152px';
				}
				else {
					me._image_1.style.left='127px';
					me._image_1.style.top='152px';
				}
			}
		}
		...
		me._image_1.logicBlock_scaling = function() {
			...
			if (me._image_1.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				if (me._image_1.ggCurrentLogicStateScaling == 0) {
					me._image_1.ggParameter.sx = 2;
					me._image_1.ggParameter.sy = 2;
					me._image_1.style.transform=parameterToTransform(me._image_1.ggParameter);
					setTimeout(function() {skin.updateSize(me._image_1);}, 1050);
				}
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'4KPC9zdmc+Cg==';
		me._infoimage__img.setAttribute('src',hs);
		hs ='';
		hs += 'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;';
		els.setAttribute('style', hs);
		els['ondragstart']=function() { return false; };
		...
		me._infoimage.onclick=function (e) {
			me._text_3.style.transition='none';
			...
			me._text_3_en.style.transition='none';
			me._text_3_en.style.visibility=(Number(me._text_3_en.style.opacity)>0||!me._text_3_en.style.opacity)?'inherit':'hidden';
			me._text_3_en.ggVisible=true;
			me._closeimage.style.transition='none';
			me._closeimage.style.visibility=(Number(me._closeimage.style.opacity)>0||!me._closeimage.style.opacity)?'inherit':'hidden';
			me._closeimage.ggVisible=true;
		}
		me._infoimage.ggUpdatePosition=function (useTransition) {
		}
		me._image_1.appendChild(me._infoimage);
		me.divSkin.appendChild(me._image_1);
		el=me._text_3_en=document.createElement('div');
		els=me._text_3_en__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="Text 3_en";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		...
		el.ggType='text';
		hs ='';
		hs+='background : #f5e8d1;';
		hs+='border : 1px solid #aaa191;';
		...
		hs+='overflow-y: auto;';
		els.setAttribute('style',hs);
		me._text_3_en.ggUpdateText=function() {
			var params = [];
			var hs = player._("\nAfter 45 years, the classic picture book series of Japanese picture book master Anno Mitsumasa\nstarts from Central Europe, the starting point of travel picture books, and then goes to Italy, which is based on the story background of the New Testament, Britain with the most beautiful villages, the United States full of history and artistic development, and then to Spain with a strong architectural and artistic atmosphere.\n\nAnno Mitsumasa takes readers on a paper journey with a unique perspective and delicate brushstrokes!", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._text_3_en.ggUpdateText();
		el.appendChild(els);
		me._text_3_en.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._text_3_en.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				((player.getViewerSize(true).width > 1000))
			)
			...
			if (me._text_3_en.ggCurrentLogicStatePosition != newLogicStatePosition) {
				me._text_3_en.ggCurrentLogicStatePosition = newLogicStatePosition;
				me._text_3_en.style.transition='left 1000ms ease 0ms, top 1000ms ease 0ms, transform 1000ms ease 0ms';
				if (me._text_3_en.ggCurrentLogicStatePosition == 0) {
					me._text_3_en.style.left='600px';
					me._text_3_en.style.top='153px';
				}
				else if (me._text_3_en.ggCurrentLogicStatePosition == 1) {
					me._text_3_en.style.left='480px';
					me._text_3_en.style.top='153px';
				}
				else {
					me._text_3_en.style.left='387px';
					me._text_3_en.style.top='153px';
				}
			}
		}
		me._text_3_en.logicBlock_position();
		me._text_3_en.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				((player.getViewerSize(true).width > 1000))
			)
			...
			if (me._text_3_en.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._text_3_en.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._text_3_en.style.transition='left 1000ms ease 0ms, top 1000ms ease 0ms, transform 1000ms ease 0ms';
				if (me._text_3_en.ggCurrentLogicStateScaling == 0) {
					me._text_3_en.ggParameter.sx = 2;
					me._text_3_en.ggParameter.sy = 2;
					me._text_3_en.style.transform=parameterToTransform(me._text_3_en.ggParameter);
					setTimeout(function() {skin.updateSize(me._text_3_en);}, 1050);
				}
				else if (me._text_3_en.ggCurrentLogicStateScaling == 1) {
					me._text_3_en.ggParameter.sx = 1.5;
					me._text_3_en.ggParameter.sy = 1.5;
					me._text_3_en.style.transform=parameterToTransform(me._text_3_en.ggParameter);
					setTimeout(function() {skin.updateSize(me._text_3_en);}, 1050);
				}
				else {
					me._text_3_en.ggParameter.sx = 1;
					me._text_3_en.ggParameter.sy = 1;
					me._text_3_en.style.transform=parameterToTransform(me._text_3_en.ggParameter);
					setTimeout(function() {skin.updateSize(me._text_3_en);}, 1050);
				}
			}
		}
		me._text_3_en.logicBlock_scaling();
		me._text_3_en.ggUpdatePosition=function (useTransition) {
		}
		el=me._text_4en=document.createElement('div');
		els=me._text_4en__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="Text 4-en";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		...
		el.ggType='text';
		hs ='';
		hs+='background : #e8dbc6;';
		hs+='border : 1px solid #e9ddc7;';
		hs+='color : rgba(75,72,47,1);';
		hs+='cursor : pointer;';
		hs+='height : 12px;';
		hs+='left : 37px;';
		hs+='position : absolute;';
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me._text_4en.ggUpdateText=function() {
			var params = [];
			var hs = player._("\u5207\u63db\u70ba\u4e2d\u6587", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._text_4en.ggUpdateText();
		el.appendChild(els);
		me._text_4en.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._text_4en.logicBlock_backgroundcolor = function() {
			var newLogicStateBackgroundColor;
			if (
				((me.elementMouseOver['text_4en'] == true))
			)
			{
				newLogicStateBackgroundColor = 0;
			}
			...
			if (me._text_4en.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				me._text_4en.ggCurrentLogicStateBackgroundColor = newLogicStateBackgroundColor;
				me._text_4en.style.transition='background-color 0s';
				if (me._text_4en.ggCurrentLogicStateBackgroundColor == 0) {
					me._text_4en.style.backgroundColor="rgba(181,171,155,1)";
				}
				else {
					me._text_4en.style.backgroundColor="rgba(232,219,198,1)";
				}
			}
		}
		me._text_4en.logicBlock_backgroundcolor();
		me._text_4en.onclick=function (e) {
			me._text_3_en.ggVisible = !me._text_3_en.ggVisible;
			var flag=me._text_3_en.ggVisible;
			me._text_3_en.style.transition='none';
			me._text_3_en.style.visibility=((flag)&&(Number(me._text_3_en.style.opacity)>0||!me._text_3_en.style.opacity))?'inherit':'hidden';
			me._text_3.style.transition='none';
			me._text_3.style.visibility=(Number(me._text_3.style.opacity)>0||!me._text_3.style.opacity)?'inherit':'hidden';
			me._text_3.ggVisible=true;
		}
		me._text_4en.onmouseenter=function (e) {
			me.elementMouseOver['text_4en']=true;
			me._text_4en.logicBlock_backgroundcolor();
		}
		me._text_4en.onmouseleave=function (e) {
			me.elementMouseOver['text_4en']=false;
			me._text_4en.logicBlock_backgroundcolor();
		}
		me._text_4en.ggUpdatePosition=function (useTransition) {
		}
		me._text_3_en.appendChild(me._text_4en);
		me.divSkin.appendChild(me._text_3_en);
		...
		me._text_3.ggUpdateText=function() {
			var params = [];
			var hs = player._("\n\u6b77\u7d9345\u5e74\uff0c\u65e5\u672c\u7e6a\u672c\u5927\u5e2b\u5b89\u91ce\u5149\u96c5\u7d93\u5178\u7e6a\u672c\u7cfb\u5217\n\u5f9e\u65c5\u4e4b\u7e6a\u672c\u7684\u8d77\u9ede\u4e2d\u6b50\u958b\u59cb\uff0c\u63a5\u8457\u5230\u4e86\u4ee5\u300a\u65b0\u7d04\u8056\u7d93\u300b\u6545\u4e8b\u80cc\u666f\u70ba\u4e3b\u7684\u7fa9\u5927\u5229\u3001\u64c1\u6709\u6700\u7f8e\u6751\u843d\u7684\u82f1\u570b\u3001\u5145\u6eff\u6b77\u53f2\u8207\u85dd\u6587\u767c\u5c55\u7684\u7f8e\u570b\uff0c\u518d\u5230\u5efa\u7bc9\u8207\u85dd\u8853\u6c23\u606f\u6fc3\u539a\u7684\u897f\u73ed\u7259\u3002\n\n\u5b89\u96c5\u5149\u96c5\u4ee5\u7368\u7279\u7684\u8996\u89d2\u3001\u7d30\u81a9\u7684\u7b46\u89f8\uff0c\u5e36\u9818\u8b80\u8005\u4e00\u540c\u7d19\u4e0a\u65c5\u884c\uff01", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._text_3.logicBlock_position = function() {
			...
			if (me._text_3.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._text_3.style.transition='left 1000ms ease 0ms, top 1000ms ease 0ms, transform 1000ms ease 0ms';
				if (me._text_3.ggCurrentLogicStatePosition == 0) {
					me._text_3.style.left='600px';
					me._text_3.style.top='153px';
				}
				else if (me._text_3.ggCurrentLogicStatePosition == 1) {
					me._text_3.style.left='480px';
					me._text_3.style.top='153px';
				}
				else {
					me._text_3.style.left='386px';
					me._text_3.style.top='153px';
				}
			}
		}
		...
		me._text_3.logicBlock_scaling = function() {
			...
			if (me._text_3.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				if (me._text_3.ggCurrentLogicStateScaling == 0) {
					me._text_3.ggParameter.sx = 2;
					me._text_3.ggParameter.sy = 2;
					me._text_3.style.transform=parameterToTransform(me._text_3.ggParameter);
					setTimeout(function() {skin.updateSize(me._text_3);}, 1050);
				}
				else if (me._text_3.ggCurrentLogicStateScaling == 1) {
					me._text_3.ggParameter.sx = 1.5;
					me._text_3.ggParameter.sy = 1.5;
					me._text_3.style.transform=parameterToTransform(me._text_3.ggParameter);
					setTimeout(function() {skin.updateSize(me._text_3);}, 1050);
				}
				else {
		...
		me._text_4.ggUpdateText=function() {
			var params = [];
			var hs = player._("change to EN", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._text_4.logicBlock_backgroundcolor = function() {
			var newLogicStateBackgroundColor;
			if (
			...
			if (me._text_4.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				me._text_4.ggCurrentLogicStateBackgroundColor = newLogicStateBackgroundColor;
				me._text_4.style.transition='background-color 0s';
				if (me._text_4.ggCurrentLogicStateBackgroundColor == 0) {
					me._text_4.style.backgroundColor="rgba(181,171,155,1)";
				}
				else {
					me._text_4.style.backgroundColor="rgba(232,219,198,1)";
				}
			}
		}
		me._text_4.logicBlock_backgroundcolor();
		me._text_4.onclick=function (e) {
			me._text_3.ggVisible = !me._text_3.ggVisible;
			var flag=me._text_3.ggVisible;
			me._text_3.style.transition='none';
			me._text_3.style.visibility=((flag)&&(Number(me._text_3.style.opacity)>0||!me._text_3.style.opacity))?'inherit':'hidden';
			me._text_3_en.style.transition='none';
			me._text_3_en.style.visibility=(Number(me._text_3_en.style.opacity)>0||!me._text_3_en.style.opacity)?'inherit':'hidden';
			me._text_3_en.ggVisible=true;
		}
		me._text_4.onmouseenter=function (e) {
			me.elementMouseOver['text_4']=true;
			me._text_4.logicBlock_backgroundcolor();
		}
		me._text_4.onmouseleave=function (e) {
		...
		el=me._closeimage=document.createElement('div');
		els=me._closeimage__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,';
		me._closeimage__img.setAttribute('src',hs);
		hs ='';
		hs += 'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;';
		els.setAttribute('style', hs);
		els['ondragstart']=function() { return false; };
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._closeimage.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._closeimage.onclick=function (e) {
			me._image_1.style.transition='none';
			me._image_1.style.visibility='hidden';
			me._image_1.ggVisible=false;
			me._text_3.style.transition='none';
			...
			me._text_3_en.style.transition='none';
			me._text_3_en.style.visibility='hidden';
			me._text_3_en.ggVisible=false;
			me._closeimage.style.transition='none';
			me._closeimage.style.visibility='hidden';
			me._closeimage.ggVisible=false;
			me._photo.style.transition='none';
			me._photo.style.visibility=(Number(me._photo.style.opacity)>0||!me._photo.style.opacity)?'inherit':'hidden';
			me._photo.ggVisible=true;
		}
		me._closeimage.ggUpdatePosition=function (useTransition) {
		}
		me.divSkin.appendChild(me._closeimage);
		el=me._photo=document.createElement('div');
		els=me._photo__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'EwIDUgMjEiLz4KPC9zdmc+Cg==';
		me._photo__img.setAttribute('src',hs);
		hs ='';
		hs += 'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;';
		els.setAttribute('style', hs);
		els['ondragstart']=function() { return false; };
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._photo.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._photo.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((me.elementMouseDown['photo'] == false))
			)
			{
				newLogicStateVisible = 0;
			}
			...
			if (me._photo.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._photo.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._photo.style.transition='';
				if (me._photo.ggCurrentLogicStateVisible == 0) {
					me._photo.style.visibility=(Number(me._photo.style.opacity)>0||!me._photo.style.opacity)?'inherit':'hidden';
					me._photo.ggVisible=true;
				}
				else {
		...
		me._photo.logicBlock_visible();
		me._photo.onclick=function (e) {
			me._photo.style.transition='none';
			me._photo.style.visibility='hidden';
			me._photo.ggVisible=false;
			me._closeimage.style.transition='none';
			me._closeimage.style.visibility=(Number(me._closeimage.style.opacity)>0||!me._closeimage.style.opacity)?'inherit':'hidden';
			me._closeimage.ggVisible=true;
		}
		me._photo.onmouseenter=function (e) {
			me.elementMouseOver['photo']=true;
		}
		me._photo.onmousedown=function (e) {
			me.elementMouseDown['photo']=true;
			me._photo.logicBlock_visible();
		}
		me._photo.onmouseup=function (e) {
			me.elementMouseDown['photo']=false;
			me._photo.logicBlock_visible();
		}
		me._photo.onmouseleave=function (e) {
			me.elementMouseDown['photo']=false;
			me.elementMouseOver['photo']=false;
			me._photo.logicBlock_visible();
		}
		me._photo.ggCurrentLogicStateVisible = -1;
		me._photo.ggUpdateConditionTimer=function () {
			if (me.elementMouseOver['photo']) {
				me._image_1.style.transition='none';
				me._image_1.style.visibility=(Number(me._image_1.style.opacity)>0||!me._image_1.style.opacity)?'inherit':'hidden';
				me._image_1.ggVisible=true;
			}
		}
		me._photo.ggUpdatePosition=function (useTransition) {
		}
		me.divSkin.appendChild(me._photo);
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'1saW5lY2FwPSJyb3VuZCIgc3Ryb2tlPSIjYzJlODEyIiBzdHJva2UtbGluZWpvaW49InJvdW5kIiBmaWxsPSJub25lIiBzdHJva2Utd2lkdGg9IjEuMjUiIHN0cm9rZS1vcGFjaXR5PSIxIiBwb2ludHM9IjcuNSw0LjUgJiN4YTsmI3g5OzI4LjUsMTggNy41LDMxLjUgIi8+Cjwvc3ZnPgo=';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		hs='data:image/svg+xml;base64,'+
		...
		el=me._play_voice1=document.createElement('div');
		els=me._play_voice1__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'AgMCAyIDJoMWEyIDIgMCAwIDAgMi0ydi0zYTIgMiAwIDAgMC0yLTJIM3oiLz4KPC9zdmc+Cg==';
		me._play_voice1__img.setAttribute('src',hs);
		hs ='';
		hs += 'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;';
		els.setAttribute('style', hs);
		els['ondragstart']=function() { return false; };
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._play_voice1.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._play_voice1.onclick=function (e) {
				player.playPauseSound("voice01","1");
		}
		me._play_voice1.ggUpdatePosition=function (useTransition) {
		}
		me.divSkin.appendChild(me._play_voice1);
		...
		hs+='cursor : pointer;';
		hs+='height : 30px;';
		hs+='left : calc(50% - ((217px + 0px) / 2) + 21px);';
		hs+='position : absolute;';
		hs+='visibility : inherit;';
		hs+='width : 217px;';
		hs+='pointer-events:auto;';
		...
		el.ggType='text';
		hs ='';
		hs+='border : 1px solid #f48f56;';
		hs+='bottom : 4px;';
		hs+='color : rgba(255,255,255,1);';
		hs+='cursor : pointer;';
		hs+='height : 20px;';
		hs+='left : calc(50% - ((100px + 2px) / 2) - 2px);';
		hs+='position : absolute;';
		hs+='visibility : inherit;';
		hs+='width : 100px;';
		hs+='pointer-events:auto;';
		...
		me._text_5.onclick=function (e) {
			player.startAutorotate(20);
		}
		me._text_5.ggUpdatePosition=function (useTransition) {
		}
		me._button_1.appendChild(me._text_5);
	...
	function SkinHotspotClass_ht_url(parentScope,hotspot) {
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
	...
	function SkinHotspotClass_ht_node(parentScope,hotspot) {
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			'N0cm9rZS13aWR0aD0iMS4yNSIgc3Ryb2tlLW9wYWNpdHk9IjEiIHBvaW50cz0iMTguMiwyLjEgJiN4YTsmI3g5OzEzLjYsNi43IDEyLjEsNS4yICIvPgo8L3N2Zz4K';
...
me._ht_image_bg.style.transform= 'translateZ(10px)';
			...
			if (
				...
				skin._image_popup_phone.ggSetImage(player._(player._(me.hotspot.url)));
			}
		}
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,';
...
me._ht_image_bg.style.transform= '';
	...
	function SkinHotspotClass_ht_info(parentScope,hotspot) {
		...
		me._ht_info_bg.logicBlock_size = function() {
			...
			if (me._ht_info_bg.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._ht_info_bg.ggCurrentLogicStateSize == 0) {
					me._ht_info_bg.style.width='450px';
					me._ht_info_bg.style.height='350px';
					me._ht_info_bg.style.left = 'calc(50% - (450px / 2))';
		...
		me._ht_info_text_body.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getViewerSize(true).width > 1000))
			)
			...
			if (me._ht_info_text_body.ggCurrentLogicStateSize != newLogicStateSize) {
				me._ht_info_text_body.ggCurrentLogicStateSize = newLogicStateSize;
				me._ht_info_text_body.style.transition='width 0s, height 0s';
				if (me._ht_info_text_body.ggCurrentLogicStateSize == 0) {
					me._ht_info_text_body.style.width='100%';
					me._ht_info_text_body.style.height='calc(100% - 35px)';
					me._ht_info_text_body.style.left = 'calc(50% - (100% / 2))';
					skin.updateSize(me._ht_info_text_body);
				}
				else {
					me._ht_info_text_body.style.width='100%';
					me._ht_info_text_body.style.height='calc(100% - 35px)';
		...
		me._ht_info_text_body.logicBlock_size();
...
me._ht_info_bg.style.transform='translateZ(10px)';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'';
...
me._ht_info_bg.style.transform='';
	...
	function SkinHotspotClass_ht_pdf(parentScope,hotspot) {
		...
		hs='data:image/svg+xml;base64,'+
			...
			'IGNsYXNzPSJzdDAiIHgxPSIxMy4zIiB5Mj0iMTAuOCIgeDI9IjYuNyIvPgogPGxpbmUgeTE9IjE0LjIiIGNsYXNzPSJzdDAiIHgxPSIxMy4zIiB5Mj0iMTQuMiIgeDI9IjYuNyIvPgogPHBvbHlsaW5lIGNsYXNzPSJzdDAiIHBvaW50cz0iOC4zLDcuNSA3LjUsNy41IDYuNyw3LjUgIi8+Cjwvc3ZnPgo=';
	...
	me.skinTimerEvent=function() {
		...
		me._photo.ggUpdateConditionTimer();
